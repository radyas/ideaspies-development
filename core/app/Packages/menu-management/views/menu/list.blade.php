@extends('layouts.back.master') @section('current_title','All Menu')
@section('css')
...
@stop
@section('content')
<div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create" onclick="location.href = '{{url('menu/add')}}';">
    <p class="plus">+</p>   
</div>
