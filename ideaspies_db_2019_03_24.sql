...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `user_id` = VALUES(`user_id`), `code` = VALUES(`code`), `completed` = VALUES(`completed`), `completed_at` = VALUES(`completed_at`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `label` = VALUES(`label`), `link` = VALUES(`link`), `icon` = VALUES(`icon`), `parent` = VALUES(`parent`), `permissions` = VALUES(`permissions`), `lft` = VALUES(`lft`), `rgt` = VALUES(`rgt`), `depth` = VALUES(`depth`), `status` = VALUES(`status`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `title` = VALUES(`title`), `slug` = VALUES(`slug`), `description` = VALUES(`description`), `user_id` = VALUES(`user_id`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`), `image` = VALUES(`image`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `news_id` = VALUES(`news_id`), `src` = VALUES(`src`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `name` = VALUES(`name`), `description` = VALUES(`description`), `status` = VALUES(`status`), `created_by` = VALUES(`created_by`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(701,	9,	'WmXTIqaDIVIz2NSY9lwk6XOMSfw7ciPd',	'2019-03-03 10:52:51',	'2019-03-03 10:52:51'),
(702,	9,	'vABdy2vLS7VEGMtlzYXdPBBcbRnMpC2s',	'2019-03-03 15:50:01',	'2019-03-03 15:50:01'),
(703,	9,	'YkSEOQSImMiSlo9fWsnCaNI9tdwvFZrP',	'2019-03-04 13:21:32',	'2019-03-04 13:21:32'),
(704,	9,	'iQZ01MvSLif62E7r3lxpigf0IXGxPa0R',	'2019-03-04 18:27:27',	'2019-03-04 18:27:27'),
(705,	9,	'IrmSBBZN9eXo5intmnnez2NMIRUCw2Lj',	'2019-03-09 09:27:57',	'2019-03-09 09:27:57'),
(706,	9,	'uYQf9bnUNZNCTcV4KOJ2Ur8CjcFkBxNk',	'2019-03-09 14:21:44',	'2019-03-09 14:21:44'),
(707,	9,	'RwkEdJpT46Hc5x5Vlodozjy1TkOqX8Uo',	'2019-03-10 03:48:55',	'2019-03-10 03:48:55'),
(726,	9,	'9RAD4k6aSaKOhzRqJG6gV1UJ7mayvxDQ',	'2019-03-20 07:00:59',	'2019-03-20 07:00:59'),
(727,	12,	'9mDEszxoLNRY9ANVJxKIUtNDRquhMZOH',	'2019-03-20 11:07:14',	'2019-03-20 11:07:14'),
(728,	12,	'Kue93rkojKn5SwAEMGdoq4KamVF7kLBZ',	'2019-03-20 11:46:02',	'2019-03-20 11:46:02'),
(730,	12,	'65AoGCvWFoYnlBU5R5cVf0PwvEG4r9IF',	'2019-03-23 09:00:00',	'2019-03-23 09:00:00')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `user_id` = VALUES(`user_id`), `code` = VALUES(`code`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'image',	'hhsbuddubv duhci d ushcushv husbuv  uhfun uhsfih ufsjkhbd ihfsb hfjbf hfhjhdyupo',	'core/storage/uploads/images/file-20190303212124.png',	NULL,	'',	1,	9,	'admin',	'2019-03-03 15:51:24',	'2019-03-17 09:02:05',	'Fatal error: Cannot redeclare insertTodo in line 16',	24),
(2,	'content',	'rgvfdx',	NULL,	NULL,	'',	4,	9,	'admin',	'2019-03-04 13:22:20',	'2019-03-17 09:38:27',	'Fatal error: Cannot redeclare insertTodo in line 16',	19),
(3,	'image',	'rtdy',	'core/storage/uploads/images/file-20190309153759.png',	NULL,	'',	1,	9,	'admin',	'2019-03-09 10:07:59',	'2019-03-09 10:36:01',	'xfgdg',	1),
(4,	'image',	'ert',	'core/storage/uploads/images/file-20190309204700.jpg',	NULL,	'',	1,	9,	'admin',	'2019-03-09 15:17:00',	'2019-03-09 15:37:05',	'stg',	1),
(5,	'image',	'sfdsd',	'core/storage/uploads/images/file-20190309210329.png',	NULL,	'',	0,	9,	'admin',	'2019-03-09 15:33:29',	'2019-03-17 08:35:41',	'sfsdf',	1),
(6,	'image',	'sefdg',	'core/storage/uploads/images/file-20190309210726.png',	NULL,	'',	0,	9,	'admin',	'2019-03-09 15:37:26',	'2019-03-09 15:37:26',	'sfs',	0),
(7,	'image',	'ert',	'core/storage/uploads/images/file-20190310093800.png',	NULL,	NULL,	2,	9,	'user',	'2019-03-10 04:08:00',	'2019-03-10 04:08:00',	'dfge',	0),
(8,	'image',	'ert',	'core/storage/uploads/images/file-20190310093813.png',	NULL,	NULL,	2,	9,	'user',	'2019-03-10 04:08:13',	'2019-03-10 04:08:13',	'dfge',	0),
(9,	'image',	'ert',	'core/storage/uploads/images/file-20190310093851.png',	NULL,	NULL,	2,	9,	'user',	'2019-03-10 04:08:51',	'2019-03-10 04:08:51',	'dfge',	0),
(10,	'image',	'werwr',	'core/storage/uploads/images/file-20190320125218.png',	NULL,	NULL,	2,	9,	'user',	'2019-03-20 07:22:18',	'2019-03-20 07:22:18',	'egtej',	0),
(11,	'video',	'wffwff',	NULL,	'core/storage/uploads/videos/file-20181027132942.mp4',	NULL,	1,	12,	'user',	'2019-03-20 11:57:50',	'2019-03-23 07:33:48',	'sdw',	10),
(12,	'url',	'fgvef',	NULL,	NULL,	'https://www.google.com',	4,	12,	'user',	'2019-03-23 07:42:06',	'2019-03-23 07:42:21',	'df',	1),
(13,	'image',	'efdgfv',	'core/storage/uploads/images/file-20190323143028.jpg',	NULL,	NULL,	1,	12,	'user',	'2019-03-23 09:00:28',	'2019-03-23 09:00:28',	'Fatal error: Cannot redeclare insertTodo in line 16',	0)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `type` = VALUES(`type`), `content` = VALUES(`content`), `img_path` = VALUES(`img_path`), `video_path` = VALUES(`video_path`), `url` = VALUES(`url`), `category_id` = VALUES(`category_id`), `added_by_id` = VALUES(`added_by_id`), `added_by_type` = VALUES(`added_by_type`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`), `title` = VALUES(`title`), `visit_count` = VALUES(`visit_count`);
...
(1,	1,	9,	'2019-03-04 13:21:43',	'2019-03-04 13:21:43'),
(2,	2,	9,	'2019-03-04 14:30:04',	'2019-03-04 14:30:04'),
(3,	3,	9,	'2019-03-09 10:08:26',	'2019-03-09 10:08:26'),
(4,	5,	9,	'2019-03-09 15:37:03',	'2019-03-09 15:37:03'),
(5,	4,	9,	'2019-03-09 15:37:03',	'2019-03-09 15:37:03'),
(6,	9,	9,	'2019-03-10 04:26:29',	'2019-03-10 04:26:29'),
(7,	8,	9,	'2019-03-10 04:26:29',	'2019-03-10 04:26:29'),
(8,	7,	9,	'2019-03-10 04:26:29',	'2019-03-10 04:26:29'),
(9,	6,	9,	'2019-03-10 04:26:29',	'2019-03-10 04:26:29')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `post_id` = VALUES(`post_id`), `user_id` = VALUES(`user_id`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
INSERT INTO `post_rates` (`id`, `user_id`, `value`, `created_at`, `updated_at`, `post_id`) VALUES
(1,	9,	4,	'2019-03-16 07:24:36',	'2019-03-16 08:02:12',	2),
(2,	9,	5,	'2019-03-16 07:35:09',	'2019-03-16 07:35:09',	8),
(3,	9,	5,	'2019-03-16 07:44:52',	'2019-03-16 07:44:52',	1),
(4,	12,	2,	'2019-03-16 08:16:11',	'2019-03-16 08:16:47',	2),
(5,	NULL,	5,	'2019-03-17 08:50:52',	'2019-03-17 08:50:52',	2),
(6,	NULL,	1,	'2019-03-17 09:38:14',	'2019-03-17 09:38:14',	2),
(7,	NULL,	1,	'2019-03-17 09:38:25',	'2019-03-17 09:38:25',	2)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `user_id` = VALUES(`user_id`), `value` = VALUES(`value`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`), `post_id` = VALUES(`post_id`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `slug` = VALUES(`slug`), `name` = VALUES(`name`), `permissions` = VALUES(`permissions`), `created_by` = VALUES(`created_by`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(12,	1,	'2019-03-16 08:14:21',	'2019-03-16 08:14:21'),
...
ON DUPLICATE KEY UPDATE `user_id` = VALUES(`user_id`), `role_id` = VALUES(`role_id`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `fb` = VALUES(`fb`), `twitter` = VALUES(`twitter`), `gplus` = VALUES(`gplus`), `linkedin` = VALUES(`linkedin`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`), `contact_num` = VALUES(`contact_num`), `address` = VALUES(`address`), `admin_email` = VALUES(`admin_email`);
...
(1,	1,	'PostManage\\Models\\Post',	'Idea',	'idea'),
(2,	1,	'PostManage\\Models\\Post',	'Spies',	'spies'),
(3,	1,	'PostManage\\Models\\Post',	'New',	'new'),
(4,	1,	'PostManage\\Models\\Post',	'Test',	'test'),
(5,	2,	'PostManage\\Models\\Post',	'Dtf',	'dtf'),
(6,	3,	'PostManage\\Models\\Post',	'Df',	'df'),
(7,	5,	'PostManage\\Models\\Post',	'Sdf',	'sdf'),
(8,	6,	'PostManage\\Models\\Post',	'Sdf',	'sdf'),
(9,	7,	'PostManage\\Models\\Post',	'Ete\\',	'ete'),
(10,	8,	'PostManage\\Models\\Post',	'Ete\\',	'ete'),
(11,	9,	'PostManage\\Models\\Post',	'Ete\\',	'ete'),
(12,	10,	'PostManage\\Models\\Post',	'Werwe',	'werwe'),
(13,	11,	'PostManage\\Models\\Post',	'Wfwf\\',	'wfwf'),
(14,	12,	'PostManage\\Models\\Post',	'Dfdf',	'dfdf'),
(15,	13,	'PostManage\\Models\\Post',	'Dsc',	'dsc')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `taggable_id` = VALUES(`taggable_id`), `taggable_type` = VALUES(`taggable_type`), `tag_name` = VALUES(`tag_name`), `tag_slug` = VALUES(`tag_slug`);
...
(1,	NULL,	'idea',	'Idea',	0,	1),
(2,	NULL,	'spies',	'Spies',	0,	1),
(3,	NULL,	'new',	'New',	0,	1),
(4,	NULL,	'test',	'Test',	0,	1),
(5,	NULL,	'dtf',	'Dtf',	0,	1),
(6,	NULL,	'df',	'Df',	0,	1),
(7,	NULL,	'sdf',	'Sdf',	0,	2),
(8,	NULL,	'ete',	'Ete\\',	0,	3),
(9,	NULL,	'werwe',	'Werwe',	0,	1),
(10,	NULL,	'wfwf',	'Wfwf\\',	0,	1),
(11,	NULL,	'dfdf',	'Dfdf',	0,	1),
(12,	NULL,	'dsc',	'Dsc',	0,	1)
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `tag_group_id` = VALUES(`tag_group_id`), `slug` = VALUES(`slug`), `name` = VALUES(`name`), `suggest` = VALUES(`suggest`), `count` = VALUES(`count`);
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `user_id` = VALUES(`user_id`), `type` = VALUES(`type`), `ip` = VALUES(`ip`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(1,	'',	'',	'Super',	'Administrator',	'super.admin',	'admin@admin.lk',	NULL,	0,	'$2y$10$vJ0/.9l8qByoN/ZFJlzew.U3SUrYnsI6QoPezSfeo9qDQYLJSjC/O',	'{\"admin\":true,\"index\":true}',	'2019-02-25 17:43:21',	NULL,	7,	20,	0,	1,	'2015-07-11 06:09:31',	'2019-03-16 08:12:33',	1),
(9,	'',	'',	'SDC',	'Developer',	'developer',	'developer@admin.com',	NULL,	1,	'$2y$10$ijimT7X0fQADncEnlwgRZelKPlCoLE81YVjgQlX25F64Ulf5JHiaG',	NULL,	'2019-03-20 07:00:59',	1,	12,	15,	1,	1,	'2017-01-23 07:05:38',	'2019-03-20 07:00:59',	1),
(10,	'',	'',	NULL,	NULL,	'lakshitham',	'rullzzm@gmail.comm',	NULL,	0,	'$2y$10$KYJLzG26TupSdCXfRh9XRO0VctPDiWMSfbr2ooltjOGpZqZvf5KSS',	NULL,	'2017-12-30 09:26:38',	NULL,	21,	22,	0,	NULL,	'2017-12-27 14:10:24',	'2019-03-16 08:12:33',	1),
...
(12,	'',	'',	'chamara abeysekara',	'sdsdd',	'aaa@aa.aa',	'aaa@aa.com',	NULL,	0,	'$2y$12$RV8gtxTzjOwvxTqTn2wYjeQrxmPnWoqqkeDlKfabDkrwwn0F35xqa',	NULL,	'2019-03-23 09:00:00',	1,	18,	19,	1,	NULL,	'2018-12-01 06:01:44',	'2019-03-23 09:00:01',	1),
...
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `fb_id` = VALUES(`fb_id`), `g_id` = VALUES(`g_id`), `first_name` = VALUES(`first_name`), `last_name` = VALUES(`last_name`), `username` = VALUES(`username`), `email` = VALUES(`email`), `mobile` = VALUES(`mobile`), `branch` = VALUES(`branch`), `password` = VALUES(`password`), `permissions` = VALUES(`permissions`), `last_login` = VALUES(`last_login`), `supervisor_id` = VALUES(`supervisor_id`), `lft` = VALUES(`lft`), `rgt` = VALUES(`rgt`), `depth` = VALUES(`depth`), `status` = VALUES(`status`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`), `active` = VALUES(`active`);
...
ON DUPLICATE KEY UPDATE `user_id` = VALUES(`user_id`), `group_id` = VALUES(`group_id`), `sbu_id` = VALUES(`sbu_id`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
